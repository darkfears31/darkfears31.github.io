---
title: "MacroHard WeakEdge from PicoCTF"
categories: [PicoCTF]
tags: [PicoCTF]
---
# MacroHard WeakEdge from PicoCTF
[page](https://play.picoctf.org/practice/challenge/130?page=13)

> Description
I've hidden a flag in this file. Can you find it? [Forensics is fun.pptm](https://mercury.picoctf.net/static/c0da20f29337e87ffb58ea987d8c596e/Forensics%20is%20fun.pptm0)

We download this file and just exploring it we can't find the file, so maybe it's hidden. After little searching .pptm file can be **.zip** so let's try it.
```
$ unzip l.pptm 
Archive:  l.pptm
...
The last file is interesting ---> **ppt/slideMasters/hidden**
It's not directory, so let's use ``cat`` on it and we get this: 
```
$ cat ppt/slideMasters/hidden
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q
```

Let's go to this site: [hash_identifier](https://hashes.com/en/tools/hash_identifier) and input our given code. We get this: 
```
ZmxhZzogcGljb0NURntEMWRfdV9rbjB3X3BwdHNfcl96MXA1fQ - Possible algorithms: Base64 Encoded String
``` 
...
Flag is : **picoCTF{D1d_u_kn0w_ppts_r_z1p5}**
